...
export async function GET(req: NextRequest) {
  ...
  const prompt =
    tab === 'medium'
      ? `Give me detailed contents of the following page: ${title}. When the content contains several concepts, topics, frameworks, tools, technologies etc, make sure there is line break between them in generated text to show separation.Please bold the key takeaways, terms, and critical steps in your response so I can scan the text easily while it generates.`
